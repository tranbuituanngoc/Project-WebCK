...
<section id="aa-error">
    <div class="eImage">
        <img src="../img/error/e504.png" alt="error504Image">
    </div>
</section>
    ...
    <footer class="footer-distributed">
        ...
        <div class="footer-right">
            <p class="footer-company-about">
                <span>VỀ CÔNG TY</span> Cảm ơn mọi đóng góp của bạn là sự phát triển của chúng tôi. Chúng tôi mong muốn
                sẽ là một trong những lựa chọn của bạn.
            </p>
