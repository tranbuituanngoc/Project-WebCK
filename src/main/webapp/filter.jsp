...
<section id="aa-gallery">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="aa-gallery-area">
                    <!-- Start gallery -->
                    <%
                        ArrayList<Propertie> list = (ArrayList<Propertie>) request.getAttribute("listFilter");
                        if (list.size() > 0) {
                    %>
                                ...
                                <article class="aa-properties-item">
                                    ...
                                    <%
                                        ...
                                        if (!(user == null)) {
                                            ...
                                            ArrayList<Propertie> listW = wishListDAO.selectByUserId(w);
                                            if (list.size() > 0) {
                                                for (Propertie propertie : listW) {
                                    %>
        ...
        <%}else {%>
        <p class="text-center">Không tìm được dự án nào phù hợp!</p>
        <%
            }
        %>
    </div>
